...
public class Java8MethodCheatSheet {
    ...
    public static void main(String[] args) {
      ...
      // forEach
        ...
        List<String> collect = employees.stream().flatMap(e -> e.getProjects().stream().map(Project::getName)).distinct().collect(Collectors.toList());
        ...
        List<Employee> collect1 = employees.stream().sorted(Comparator.comparing(Employee::getSalary)).collect(Collectors.toList());
...
//        descSortedEmployees.get(0);
        ...
        //System.out.println("employeeGroupNames"+employeeGroupNames);
